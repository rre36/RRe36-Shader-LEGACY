...
////////////////////sunglow color////////////////////
////////////////////sunglow color////////////////////
	const ivec4 ToD4[25] = ivec4[25]
							(ivec4(0,	0,8,14), //hour,r,g,b
							ivec4(1,	0,8,14),
							ivec4(2,	0,8,14),
							ivec4(3,	0,8,12),
							ivec4(4,	0,8,10),
							...
							ivec4(13,	255,255,255),
							ivec4(14,	255,255,255),
							ivec4(15,	150,175,175),
							ivec4(16,	130,130,130),
							ivec4(17,	130,100,85),
							ivec4(18,	120,60,15),
							ivec4(19,	110,40,0),
							ivec4(20,	70,25,10),
...
vec3 sky_color = ivec3(35,95,255)/255.0;								
/*--------------------------------*/							
...
timeSun			= timeSunrise + timeNoon + timeSunset;
	...
	colorSunglow = mix(vec3(tempc.yzw),vec3(tempc2.yzw),(hour-float(tempc.x))/float(tempc2.x-tempc.x))/255;
	
	colorMoonglow = vec3(0,8,15)/255;
	/*--------------------------------*/
